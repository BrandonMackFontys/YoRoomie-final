    ...
    return (
        <MobileShell title={<img src="../src/assets/logo-wit.png" alt="Logo" width="250" className="header-logo" />}>
            ...
            <section className="hero-card">
                <div>
                    <h2>Selecteer een huishouden</h2>
                </div>
                ...
                {recentTasks.length === 0 ? (
                    ...
                    <div className="household-cards">
                        {recentTasks.map((task) => (
                            <article key={task.id} className="real-task-card">
                                <button 
                                    type="button"
                                ...
                                >
                                    {task.status === "done" && (
                                        <svg style={{ pointerEvents: 'none' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
